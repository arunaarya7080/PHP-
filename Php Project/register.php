...
<section id="Registrations" class="pb-5">
...
<form action="insertquery.php" method="POST" enctype="multipart/form-data" class="row g-3">

  <div class="col-md-6">
    <label for="First name" class="form-label">First name</label>
    <input type="text" name="fname" value="" class="form-control" placeholder="" aria-label="First name">
  </div>
  <div class="col-md-6">
    <label for="Last name" class="form-label">Last name</label>
    <input type="text" name="lname" value="" class="form-control" placeholder="" aria-label="Last name">
  </div>
...
<div class="form-check form-check-inline">
  ...
  <div class="col-12">
    ...
    <input type="text"  name="address" value="" class="form-control" id="inputAddress" placeholder="">
  </div>
  ...
  <div class="col-md-2">
    ...
    <input type="text"  name="zip"  value="" class="form-control" id="inputZip">
  </div>
...
<div class="form-file">
  ...
  <div class="col-12">
    <button type="submit" name="submit" class="btn btn-primary">Submit Now</button>
     <a class="pl-4" href="login.php"><u>Login Here</u><a/>
  </div>
</form>
    </div>
  </div>
