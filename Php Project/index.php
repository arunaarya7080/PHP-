    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          ...
          <h2>We are team of talanted designer & Developer making websites with HTML5, CSS, Bootstrap, Javascript, PHP, Mysql, CMS Is Wordpress And FrameWork Is Laravel .</h2>
          <div class="d-lg-flex">
            <a href="#contact" class="btn-get-started scrollto">Contact Today</a>
            <a href="http://codecreater.in/" class="venobox btn-watch-video" data-vbtype="video" data-autoplay="true"> Watch Video <i class="icofont-play-alt-2"></i></a>
          </div>
        </div>
