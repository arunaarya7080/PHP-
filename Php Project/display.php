...
<section class="border border-success border-3">
<div class="text-center my-5">
   <div class="container">
      <h1 class="text-center text-success">Welcome <?php echo $_SESSION['fname'];?></h1>
     </div>
    <h1 class="display-6">You Are Login & Form Data Display</h1>
    <hr class="w-25 mx-auto"/>
     <button class="btn-danger" type=""><a href="logout.php">LOGOUT</a></button>
  </div>

<div class="px-4 table_div mt-5">
...
$selectquery = "select * from crudtb";
