...
<section class="border border-success border-3 mt-5">
     <div class="text-center pt-5">
    <h1 class="display-5">Login Pannel</h1>
...
<div class="d-flex justify-content-center align-items-center flex-column">
  <form action="loginvalidation.php" method="POST" enctype="multipart/form-data" class="row g-3">
  <div class="col-md-12">
  ...
  <div class="col-12">
    ...
    <a class="pl-4" href="register.php"><u>Sign In Here</u><a/>
  </div>
</form>
</div>
  </div>
